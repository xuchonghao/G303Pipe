...
//       XMLOut.output(doc, new FileOutputStream("C://Users//Administrator//Desktop//test1234.xml"));
    ...
    private static void addDUParatition(ArrayList<VLInfo> vlInfoList,Element pInqueue,String parId,int x,int y) {
        ...
        Element place0 = buildPlace(net, placeId0, 1, x+k, y+w);
    ...
    public static void addSPM(GuideModel guideModel, ArrayList<Element> arr){
        ...
        for(int i=0; i< size; i++)
        {
            ...
            for(int j=0;j<numPar;j++){
                ...
                y = y + 250 * numOfVl + 90;//每两个分区高度差为700
            }
            endY = y;
            y = y + 100;//每两个SPM
            ...
            Element place = buildPlace(net, placeId, 1, 1200,transMY) ;
            System.out.println(transMY);
            ...
            //构建SPM后面的链路
            linkEndElement = addSPMLink(net,1200,transMY,spmId+"L",place,lMax);
