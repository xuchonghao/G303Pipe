...
public class PlaceView extends ConnectableView implements Serializable
{
    ...
    private double forAverageDelay;

    public double getForAverageDelay() {
        return forAverageDelay;
    }

    public void setForAverageDelay(double forAverageDelay) {
        this.forAverageDelay = forAverageDelay;
    }
